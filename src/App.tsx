...
プロの世界で証明し続けてきた比類なき価値が、引退した途端に「サッカー以外のスキルを持たない者」という偏見で片付けられてしまう。
そんな不条理な現実に、我々はどうしても抗いたい。


この現実を払拭し、人生の主導権を握り続ける。
その未来を切り拓くための「確固たる武器」。それが「英語力」であると、我々は信じている。
...
ただ、忘れないでほしい。その「確固たる武器」を掴み取れるかどうかの勝負は、すでに始まっている。
...
理想を現実にするスピードを決定づける。この貴重なチャンスを、決して無駄にしてほしくない。

そして、引退後のキャリアへの不安は、今を全力で生きる者なら、誰もが心のどこかに抱く影かもしれない。けれど、ピッチを離れてから準備を始めるのでは、自らの手で選べる未来は、あまりに少なくなってしまう。


英語学習は、「勉強」そのものではない。理想を実現するための「最高の投資」だ。

また、「3ヶ月でペラペラ」なんていう手品のような魔法は、一切この世に存在しない。
短期間で取り繕った知識や技術は、簡単に崩れ落ちる。時間をかけて積み上げた本質的なモノだけが、あなたの人生を前進させる本物の武器となる。


この積み上げの果てに、我々は、単なる英語力以上のものを手にする。
それは、人生のハンドルを握り続けるための「権利」だ。

「外国人の監督やチームメイトと深い関係性を構築し、様々な機会を自ら掴み取る権利」。

「競技以外の活動を、日本国内に留まらず、グローバルの場で実施する権利」。

「引退後に、英語という武器を活用しながら、現役時代に積み上げた資産を何倍にも膨らませた新しい闘いに挑む権利。


プロサッカー選手が英語を通して、人生をより豊かにする権利を獲得する。
そんな世界を、一部の選手だけの特権ではなく、すべての選手が実現できるように。
我々は、プロサッカー選手のための英語学習サービスを作った。
...
我々も、ありたき姿を実現するために、毎日欠かさず英語を学び続けています。
        ...
        <div className="max-w-[840px] mx-auto w-full">
          ...
          <div className="mb-16">
            ...
            <div className="text-center text-neutral-900 font-sans font-extrabold text-[16px] sm:text-[19px] tracking-wide leading-relaxed mb-10 py-2">
              具体的には、「細分化したスキル別の自学習」に焦点を当てた学習を実施します。
            </div>
        ...
        <div className="max-w-[940px] mx-auto w-full">
          ...
          <div className="bg-white rounded-3xl p-6 sm:p-10 shadow-md border border-[#F1E8C9]/30 w-full select-none">
            ...
            <div className="mt-4 text-left text-[11px] sm:text-[12.5px] font-bold text-neutral-500 leading-relaxed font-sans select-none space-y-1">
              <p>※Jリーグ所属選手は、選手会の就学支援金制度（年間最大20万円の補助金）の活用を推奨</p>
