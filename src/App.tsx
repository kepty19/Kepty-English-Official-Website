...
プロの世界で証明し続けてきた比類なき価値が、引退した途端に「サッカーという頂を極めた代償に、それ以外のスキルを持たない者」という偏見で片付けられてしまう。
そんな不条理な現実に、僕はどうしても抗いたい。


この現実を自らの力で払拭し、人生の主導権を握り続ける。
その未来を切り拓くための「確固たる武器」。それが「英語力」であると、僕は信じている。
...
短期間で取り繕った知識や技術は、簡単に崩れ落ちる。時間をかけて積み上げた本質的なモノだけが、あなたの人生を前進させる"本物の武器"となる。
        ...
        <div className="max-w-[940px] mx-auto w-full">
          ...
          <div className="bg-white rounded-3xl p-6 sm:p-10 shadow-md border border-[#F1E8C9]/30 w-full select-none">
            ...
            <div className="mt-4 text-left text-[11px] sm:text-[12.5px] font-bold text-neutral-500 leading-relaxed font-sans select-none space-y-1">
              ...
              <p>※その他のリーグに所属する選手は、選手会の就学支援金制度が存在しないため、最大20万円を弊社負担で支援可能</p>
